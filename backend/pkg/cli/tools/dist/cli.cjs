...
program.command("index <input> ").option("-m <numbe>", "--maxlines <numbe>", "Maximum number of lines for each snippet").description("Index the given files.").action(async (input, cmd) => {
